...
! function(t, e) {
    ...
    var l = function(t) {
        ...
        return _inherits(Image, o), _createClass(Image, [{
            ...
            value: function() {
                var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                _get(_getPrototypeOf(Image.prototype), "destroy", this).call(this, t), this._bitmap && this._bitmap.destroy(),
                    this._bitmap = null;
            }
        }, {
            key: "dispose",
    ...
    var f = function(t) {
        function ColorPicker() {
            var t, e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
            return _classCallCheck(this, ColorPicker), (t = _possibleConstructorReturn(this, _getPrototypeOf(ColorPicker).call(this, !1)))._gridSize = 11,
                t._bgColor = "#ffffff", t._borderColor = "#000000", t._inputColor = "#000000", t._inputBgColor = "#efefef",
                t._colors = [], t._selectedColor = "#000000", e && (t.preinitialize(), t.createChildren(),
                    t.initialize()), t;
        }
        return _inherits(ColorPicker, o), _createClass(ColorPicker, [{
            ...
            value: function() {
                var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                e.ILaya.stage.off(e.Event.MOUSE_DOWN, this, this.removeColorBox), _get(_getPrototypeOf(ColorPicker.prototype), "destroy", this).call(this, t),
    ...
    var m = function(t) {
        ...
        return _inherits(List, u), _createClass(List, [{
            ...
            value: function(t, e, i) {
                ...
                for (var _ = t; _ < i; _++)
                    for (var g = 0; g < e; g++)(n = o && o.length ? o.pop() : this.createItem()).x = (this._isVertical ? g : _) * a - s._x,
            ...
            value: function() {
                ...
                if (this.cacheContent) a = i + 1, this._createdLine - s < a && (this._createItems(this._createdLine, e, this._createdLine + a),
                    this.renderItems(this._createdLine * e, 0), this._createdLine += a);
                else {
                    var n = s * e,
                        a = 0;
    ...
    e.ILaya.regClass(w), e.ClassUtils.regClass("laya.ui.UIGroup", w), e.ClassUtils.regClass("Laya.UIGroup", w);
    var I = function(t) {
        function RadioGroup() {
            return _classCallCheck(this, RadioGroup), _possibleConstructorReturn(this, _getPrototypeOf(RadioGroup).apply(this, arguments));
        }
        return _inherits(RadioGroup, w), _createClass(RadioGroup, [{
            key: "createItem",
            value: function(t, e) {
                return new x(t, e);
            }
    ...
    var L = function(t) {
        ...
        return _inherits(Tab, w), _createClass(Tab, [{
            key: "createItem",
            value: function(t, e) {
                return new _(t, e);
            }
    ...
    var N = function(t) {
        ...
        return _inherits(View, e.Scene), _createClass(View, [{
            ...
            key: "__init__",
            value: function() {
                e.ILaya.ClassUtils.regShortClassName([B, _, E, f, u, P, g, d, S, o, k, M, l, y, m, T, b, x, I, v, p, L, O, View, C, U, D, A, H, e.Animation, e.Text, R]);
            }
        }, {
            key: "regComponent",
            value: function(t, i) {
    ...
    e.ILaya.regClass(F), e.ClassUtils.regClass("laya.ui.WXOpenDataViewer", F), e.ClassUtils.regClass("Laya.WXOpenDataViewer", F),
        ...
        t.LayoutBox = z, t.List = m, t.Panel = T, t.ProgressBar = b, t.Radio = x, t.RadioGroup = I,
        ...
        t.UIEvent = h, t.UIGroup = w, t.UILib = G, t.UIUtils = r, t.VBox = H, t.VScrollBar = C,
